    ...
    <table id="produkTable" class="table table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th>Gambar</th>
                <th>
                    <a href="tambah-produk.php" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a>
                </th>
            </tr>
        </thead>
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <img src="../images/produk/<?php echo htmlspecialchars($row['gambar']); ?>" width="100" alt="<?php echo htmlspecialchars($row['nama']); ?>">
                    </td>
                    <td>
